...
CicadaGallery is available in two editions: Free and Premium.
...
| 🖱️ Drag & Drop | Add videos and folders via drag & drop |
...
- Video limit: Up to 100 videos
- Scene detection: Up to 5 scenes
- Rating: Favorite (★) only

---

## Premium Features

Purchase a premium license to unlock all features.

| Feature | Description |
|---------|-------------|
| 🎬 Scene Detection | Auto-detect scene changes and generate thumbnails |
| ⭐ 1-5 Star Rating | 5-level rating system |
| 🎨 GLSL Shaders | Custom shaders like Anime4K support |
| 🖥️ GPU HQ Rendering | MPV gpu-hq profile |
...
For premium license purchase information, see the [Download Page](download.md).
